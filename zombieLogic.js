    ...
    function spawnZombie() {
        ...
        const walk = setInterval(() => {
            ...
            if (!zombie.dataset.eating) {
                const currentLeft = parseFloat(zombie.style.left) || zombie.offsetLeft;
                const speed = zombie.dataset.slowed ? 0.50 : 1;
    ...
    function spawnGargantuar() {
        ...
        const walk = setInterval(() => {
            ...
            if (!gargantuar.dataset.eating) {
                const currentLeft = parseFloat(gargantuar.style.left) || gargantuar.offsetLeft;
                const speed = gargantuar.dataset.slowed ? 0.50 : 0.80;
                gargantuar.style.left = (currentLeft - speed) + 'px';
            }
